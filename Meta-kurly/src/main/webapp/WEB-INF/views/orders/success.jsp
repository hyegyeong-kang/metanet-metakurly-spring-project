...
<style>
  ...
  <main>
	...
	<div
				...
				<a href="/orders/detail/${order.o_id}"
					style="margin: 0; padding: 0; border: 0; box-sizing: border-box; font-size: 14px; line-: 22px; font-family: '맑은고딕', 'malgun gothic', 'dotum', sans-serif; letter-spacing: -1px; display: inline-block; min-: 135px; :40 px; margin: 19px 0 0; padding: 8px 15px 10px; border-radius: 5px; border: 0; background: #7B68EE; color: #fff; font-size: 16px; line-: 22px; letter-spacing: -1px; font-family: 'nanumbarungothicbold'; font-weight: bold; cursor: pointer; text-decoration: none; text-align: center;">주문내역조회</a>
			</div>
		</div>
					...
					<div
						...
						<div style="padding: 4px 0 0;">
							...
							<span
								...
								<fmt:formatNumber type="number" maxFractionDigits="3" value="${detail.productDTO.price}" />
								<em
					...
					<tbody>
						...
						<tr>
							...
							<td
								...
								주소 : <c:out value="${member.address}"/><!--  <span
						...
						<tr>
							...
							<td
								style="width: 558px; border: 0; box-sizing: border-box; font-size: 14px; line-height: 22px; font-family: '맑은고딕', 'Malgun Gothic', 'dotum', sans-serif; letter-spacing: -1px; padding: 14px 0 16px 16px; line-height: 20px; color: #333; border-bottom: 1px solid #e6e6e6;"><c:out value="${msg}"/></td>
						</tr>
					</tbody>
				</table>
			</div>
