		...
		<tbody>
			...
			<tr>
				...
				<c:forEach items="${products}" var="product">
					<td><img src='<c:out value="${product.img_url}"/>'></td>
					<td>${product.brand}</td>
					<td>${product.name}</td>
					<td>${product.brand}</td>
					<td>수량 <c:out value="${product.quantity}" />개
					</td>
				</c:forEach>
			</tr>
			<tr>
				...
				<td>사용할 적립금 <input type='text' id="usePointInput"
					name='usePoint'>
					<p id="errorMsg"></p>
				</td>
				<td>결제 금액
				...
				<td>결제 방법</td>
				<td><select name="paymentMethod" id="method">
