  ...
  <div class="membership">
    ...
    <form action="${path}/member/modify" id="modifyForm" method="post">
      ...
      <div>
        ...
        <input name="name" type="text" placeholder="이름을 입력해주세요" value="${name}" required>
      </div>

      <div>
        <div>이메일<span class="orange">&nbsp;*</span></div>
        <input name="email" type="text" placeholder="ex) marketkurly@kurly.com" value="${email}" required>
      </div>

      <div>
        <div>휴대폰<span class="orange">&nbsp;*</span></div>
        <div>
          <input name="phone" type="text" placeholder="ex) 010-1234-5678" value="${phone}">
        </div>
      </div>

      <div>
        <div>주소<span class="orange">&nbsp;*</span></div>
        <input name="address" type="text" placeholder="주소지 입력" value="${address}" required>
      </div>
